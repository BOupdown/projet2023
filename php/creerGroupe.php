                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('nomGroupe', $errors)) {
                                echo 'class="erreur"';
                            } ?>name="nomGroupe" type="text" placeholder="Entrez votre nom de groupe" value=<?php if (isset($_SESSION['nomGroupe'])) {
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('dataChallenge', $errors)) {
                                echo 'class="erreur"';
                            } ?>name="dataChallenge" id="search" type="text"
                                placeholder="Entrez le nom du data challenge" value=<?php if (isset($_SESSION['prenom'])) {
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('etudiant1', $errors)) {
                                echo 'class="erreur"';
                        ...
                        <div class="input-box">
                            ...
                            <div class="input-group">
                                <input type="text" name="search" id="search" class="etudiant2"
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('etudiant2', $errors)) {
                                echo 'class="erreur"';
                            } ?>name="etudiant3" type="text" placeholder="Entrez le nom de l'étudiant 3"
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('etudiant4', $errors)) {
                                echo 'class="erreur"';
                            } ?>name="etudiant4" type="text" placeholder="Entrez le nom de l'étudiant 4" value=<?php if (isset($_SESSION['etudiant4'])) {
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('etudiant5', $errors)) {
                                echo 'class="erreur"';
                            } ?>name="etudiant5" type="text" placeholder="Entrez le nom de l'étudiant 5" value=<?php if (isset($_SESSION['etudiant5'])) {
                                 echo $_SESSION['etudiant5'];
                             } ?>>
                        </div>
                        <?php
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('etudiant6', $errors)) {
                                echo 'class="erreur"';
                            } ?>name="etudiant6" type="text" placeholder="Entrez le nom de l'étudiant 6" value=<?php if (isset($_SESSION['etudiant6'])) {
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('etudiant7', $errors)) {
                                echo 'class="erreur"';
                            } ?>name="etudiant7" type="text" placeholder="Entrez le nom de l'étudiant 7" value=<?php if (isset($_SESSION['etudiant7'])) {
                        ...
                        <div class="input-box">
                            ...
                            <input <?php if (in_array('etudiant8', $errors)) {
                                echo 'class="erreur"';
                            } ?>name="etudiant8" type="text" placeholder="Entrez le nom de l'étudiant 8" value=<?php if (isset($_SESSION['etudiant8'])) {
